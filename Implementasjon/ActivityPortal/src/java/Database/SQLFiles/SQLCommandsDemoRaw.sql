...
INSERT INTO person VALUES(13, 'Jan', 'Hansen', 70, 'Skogsstien 14', 7054)
...
CREATE TABLE activity(activity_id INT NOT NULL, activity_name VARCHAR(60) NOT NULL, activity_description VARCHAR(2500), town_id INT, activity_date DATE NOT NULL, imageUrl VARCHAR(60), PRIMARY KEY(activity_id))
ALTER TABLE activity ADD FOREIGN KEY(town_id) REFERENCES town(town_id)
INSERT INTO activity VALUES(1, 'Teater: "Kristin Lavransdatter"', 'Forestilling med "Kristing Lavransdatter" på Trøndelag Teater. Oppmøte kl 18:00. Ring 90 69 54 17 for å ordne transport, senest 8. april kl 15:00.', 1, '2014-04-09', 'Teater2.png')
INSERT INTO activity VALUES(2, 'Kakefest hos Aud', 'Aud Johansen ønsker å invitere til fest med kake hjemme hos seg. Addressen er Moholt Gate 13, på Moholt. Tidspunkt: Kl 18:00. \nFor de som trenger hjelp med transport, ring 90 69 54 17 for å ordne avtale. \nFor de som reiser med buss: Ta buss rute nummer 5 som kjører fra Trondheim Sentrum. Gå av på Moholt Studentby. Erik Johansen vil vise vei fra bussholdeplasesn fra og med 17:30.\nFor de som kjører bil: Om du kommer fra Omkjøringsveien, ta av ved Moholt og kjør sørover. Ta av 2. gate til høyre og kjør forbi Trondheim Økonomiske Høgskole. Sving til venstre ved 5. gate.\nOm du kommer sørfra, er Trondheim Økonomiske Høgskole første gate til venstre.', 1, '2014-05-04', 'Cake2.png')
INSERT INTO activity VALUES(3, 'Museumsbesøk Trondheim Kunstmuseum', 'Besøk på Trondheim Kunstmuseum. Oppmøte er 15:30 i sentrum.',1, '2014-05-01', 'Painting1.jpg')
INSERT INTO activity VALUES(4, 'Politisk diskusjon', 'Diskutere det kommende året politisk. Det blir hjemme hos Alfhild. Ring 90 69 54 17 for å melde transportbehov', 1, '2014-01-01', 'Politics.jpg')
INSERT INTO activity VALUES(5, 'Politisk diskusjon', 'Diskutere utfallet og konsekvensene av reservasjonsdebatten. Det blir hjemme hos Hans Hansen Hansensen på Gimse. Transport fra Melhus sentrum 17:00.', 2, '2014-05-13', 'Politics.jpg')
INSERT INTO activity VALUES(6, 'Teater: "De Miserable"', 'Forestilling med det franske stykket "De Miserable" på Trøndelag Teater. Oppmøte kl 19:00', 1, '2014-05-13', 'Teater2.png')
INSERT INTO activity VALUES(7, 'Fjelltur på Vassfjellet', 'Tur til toppen av Vassfjellet, ved Topphytta. Ring 90 69 54 17 for påmelding. Transport vil ordnes. Elever fra Nille Videregående Skole stiller opp. Det er 20 sitteplasser tilgjengelig i og utenfor hytta, i tillegg tar arrangør med flere stoler og sitteunderlag. Toalett finnes i hytta.', 1, '2014-07-02', 'Vassfjellet2.png')
INSERT INTO activity VALUES(8, 'Skitur på Gråkallen', 'Ring 90 69 54 17 for påmelding. Elever fra Rimi Videregående Skole stiller opp', 1, '2014-04-02', 'SnowForrest.jpg')
INSERT INTO activity VALUES(9, 'Skitur i Flåmarka', 'Ring 90 69 54 17 for påmelding. Elever fra Jernia Videregående Skole stiller opp', 1, '2014-04-05', 'SnowForrest.jpg')
...
INSERT INTO activity VALUES(12, 'Vaffel og sang', 'Trine Katrine Larsen arrangerer sangkveld med vaffel. Stedet er Moholtsalen, adressen er Moholtstien 13. Tid er kl 18:00', 1, '2014-04-17', 'Waffles.jpg')
CREATE TABLE activity_interest(activity_id INT NOT NULL, interest_id INT NOT NULL, PRIMARY KEY(activity_id, interest_id))
ALTER TABLE activity_interest ADD FOREIGN KEY(activity_id) REFERENCES activity(activity_id)
ALTER TABLE activity_interest ADD FOREIGN KEY(interest_id) REFERENCES interest(interest_id)
...
CREATE TABLE activity_person(activity_id INT NOT NULL, person_id INT NOT NULL, PRIMARY KEY(activity_id, person_id))
ALTER TABLE activity_person ADD FOREIGN KEY(activity_id) REFERENCES activity(activity_id)
ALTER TABLE activity_person ADD FOREIGN KEY(person_id) REFERENCES person(person_id)
