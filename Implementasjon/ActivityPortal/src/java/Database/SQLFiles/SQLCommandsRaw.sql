...
CREATE TABLE person(person_id INT NOT NULL, last_name VARCHAR(50) NOT NULL, first_name VARCHAR(70) NOT NULL, age INT, address VARCHAR(50), post_id INT, PRIMARY KEY(person_id));
...
INSERT INTO activity VALUES(3, 'Politisk diskusjon', 'Diskutere det kommende året politisk. Det blir hjemme hos Alfhild. Ring 90 69 54 17 for å melde transportbehov', 1, '2014-01-01'); -- Testing for date-filtering
